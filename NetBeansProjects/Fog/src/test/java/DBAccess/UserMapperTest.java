...
//        // Can we log in
//        Employee user = EmployeeMapper.login( "jens@somewhere.com", "jensen" );
...
//        Employee user = EmployeeMapper.login( "jens@somewhere.com", "larsen" );
//    }
//
//    @Test
...
//        Employee original = new Employee( "king@kong.com", "uhahvorhemmeligt", "konge" );
//        EmployeeMapper.createUser( original );
//        Employee retrieved = EmployeeMapper.login( "king@kong.com", "uhahvorhemmeligt" );
